                ...
                if(body.IsTracked){
                    ...
                    if(head.Position.Z < 3.0f && head.Position.Z > 1.0f){
                        ...
                        && body.HandRightState == HandState.Open && body.HandLeftState == HandState.Open){
                            ...
                            numberRight = Math.Round((Double)numberRight, 6);
                            numberLeft = Math.Round((Double)numberLeft, 6);
                            //Debug.Log("HandRight_double:" + numberRight + ", HandLeft_double:" + numberLeft);

                            //
                            if((numberRight * 1000000) % 2 == 0 && (numberLeft * 1000000) % 2 == 0 && Camera.main.fieldOfView > 30.0f){
